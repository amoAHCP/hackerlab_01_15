package ch.trivadis.hackerlab.main;

/**
 * Created by Andy Moncsek on 19.01.15.
 */
...
/**
 * Created by Andy Moncsek on 16.01.15.
 */
public class CalculatorStandaloneApp extends Application {
    ...
    public static void main(String[] args) { FlatterFX.style();launch(args); }
