 ...
 *
 ************************************************************************/
package ch.trivadis.hackerlab.perspective;
...
@Perspective(id = BasicConfig.PERSPECTIVE_ONE,
        ...
        components = {
                BasicConfig.COMPONENT_CALCULATOR,
...
/*
        ...
        final Button pressMe = new Button(resourceBundle.getString("p2.button"));
...
*/
        ...
        // let them grow
        LayoutUtil.GridPaneUtil.setFullGrow(ALWAYS, mainContent);
        // Register root component
        perspectiveLayout.registerRootComponent(mainContent);
        // register left menu
        // register main content
        perspectiveLayout.registerTargetLayoutComponent(BasicConfig.TARGET_CONTAINER_LEFT, mainContent);
